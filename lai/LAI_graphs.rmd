...
```{r}
Figure_LAI1 <- ggplot(LAI_data_reorder, aes(x= country_name, y = D_LAI_2014))+ 
...
```{r}
Figure_LAI2 <- ggplot(LAI_data_reorder_2000, aes(x= country_name, y = D_LAI_2000))+ 
  geom_col(stat = "identity", fill = "#D3D3D3")+
  ylim(0, 80)+
  theme_minimal()+
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))+
...
```{r}
Figure_LAI3 <- ggplot(LAI_data_reorder_1990, aes(x= country_name, y = D_LAI_1990))+ 
  geom_col(stat = "identity", fill = "#D3D3D3")+
  ylim(0, 80)+
  theme_minimal()+
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))+
...
```{r}
Figure_LAI4 <- ggplot(LAI_data_reorder_change, aes(x= country_name, y = D_LAI_changes_1990_2014))+ 
  geom_col(stat = "identity", fill = "#D3D3D3")+
  theme_minimal()+
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))+
...
```{r}
Figure_LAI5 <- ggplot(LAI_data_reorder_2010, aes(x= country_name, y = D_LAI_2010))+ 
  geom_col(stat = "identity", fill = "#D3D3D3")+
  ylim(0, 80)+
  theme_minimal()+
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))+
...
```{r}
tiff("LAI_allcountries_2014_600dpi.tiff", width = 5500, height = 4000, res=600)
Figure_LAI1
dev.off()
```

```{r}
tiff("LAI_allcountries_2000_600dpi.tiff", width = 5500, height = 4000, res=600)
Figure_LAI2
dev.off()
```

```{r}
tiff("LAI_allcountries_1990_600dpi.tiff", width = 5500, height = 4000, res=600)
Figure_LAI3
dev.off()
```

```{r}
tiff("LAI_allcountries_Change_600dpi.tiff", width = 5500, height = 4000, res=600)
Figure_LAI4
dev.off()
```

```{r}
tiff("LAI_allcountries_2010_600dpi.tiff", width = 5500, height = 4000, res=600)
Figure_LAI5
dev.off()
```
...
```{r}
Figure_LAI6 <- ggplot(LAI_data_select_long, aes(y=LAI, x=country_name)) + 
...
```{r}
Figure_LAI7 <- ggplot(LAI_data_select_long, aes(y=LAI, x=country_name)) + 
    geom_bar(position="dodge", stat="identity", aes(fill = year))+
...
```{r}
tiff("LAI_selectcountries_grouped_blackandwhite_600dpi.tiff", width = 5500, height = 4000, res=600)
Figure_LAI6
dev.off()
```
...
```{r}
tiff("LAI_selectcountries_grouped_colour_600dpi.tiff", width = 5500, height = 4000, res=600)
Figure_LAI7
dev.off()
```