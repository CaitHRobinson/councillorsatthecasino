```{r}
setwd("C:/Users/chrobin/OneDrive - The University of Liverpool/LocalGovernment/Datasets/TradingAccounts")
getwd()
```
#Load the libraries
...
```{r}
tiff("Boxplots_Average_400.tiff", width = 3500, height = 3500, res=500)
p4
dev.off()
```